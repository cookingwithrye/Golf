...
namespace LeagueCreator.Factories
{
    ...
    public static class PlayerFactory
    {
        ...
        public static IPlayer CreatePlayer(string Firstname, string Lastname, string IsCaptain, string Phone, string Email, string HasRestriction, string MemberID)
        {
            return new Player(Firstname.Trim(), Lastname.Trim(), Phone: Phone.Trim(), Email: Email.Trim(), HasRestriction: HasRestriction.Trim(), MemberID: MemberID.Trim(),
